 ...
 *
 * Change Log:
 *  2013-0228 + Added column to TBL_BUG, 'Related_Bug_Id' for cloning bugs across different versions
...
/*
  ...
  * 2013-0228 + Added column, 'Related_Bug_Id' for cloning bugs across different versions
*/
...
CREATE TABLE IF NOT EXISTS `TBLPMT_TASK_UPDATE`
(
